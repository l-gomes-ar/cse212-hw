public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Dequeue tried to access an elem in an index out of range. Dequeue should always remove an elem from the front
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was adding elements to the front of List
