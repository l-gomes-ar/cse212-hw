...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Dequeue was dequeuing from the back, instead of front, as per FIFO rules.
    ...
    // Defect(s) Found: None (After correcting dequeue error on the previous test)
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite turns with 0 hadn't been implemented in TakingTurnsQueue.GetNextPerson.
    ...
    // Defect(s) Found: Infinite turns with negative numbers hadn't been implemented in TakingTurnsQueue.GetNextPerson.
